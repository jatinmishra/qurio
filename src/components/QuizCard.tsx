          ...
          <div className="space-y-3 mb-6">
            {question.options.map((option, index) => (
              <button
                ...
                className={`w-full text-left p-4 rounded-lg border transition-all duration-200 ${getButtonStyle(index)
                  }`}
                disabled={showResult}
              >
                <div className="flex items-start">
                  <span className="w-6 h-6 rounded-full border border-current flex items-center justify-center mr-3 text-xs flex-shrink-0 mt-0.5">
